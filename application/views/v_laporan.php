...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/admin/img/mdr-logo.png" />
	  ...
	  -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= site_url(); ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">PT Mangli Djaya Raya</span>
            </a>
        ...
        <div class="card-body">
        <form action="<?php echo base_url(); ?>Laporan/laporan" method="POST" class="row">
            <div class="col-md-2">
            ...
            <a class="btn btn-info" href="<?php echo base_url(); ?>Laporan/laporan">Reset</a>
            <div class="col-md-2">
            <a class="btn btn-success" href="<?php echo base_url(); ?>Laporan/cetakMasuk">Print</a>
            </div>
        </form>
            <div class="table-responsive">
                 <table id="userTable" class="table table-striped table-hover table-bordered  table-custom">
                    ...
                    <tbody>
                        ...
                        <td><?= $a->satuan  ?></td>
                        <td><?= $a->jenis  ?></td>
                        <td><img src="<?= base_url('assets/img/'.$a->bukti_terima) ?>" width='50' height='60'></td>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2016 <a href="#">sas</a>.</strong> All rights reserved.
        </footer>
        <!-- Control Sidebar -->
    ...
    $(document).ready(function() {
        var userDataTable = $('#userTable').DataTable({
            ...
            'columns': [{
                ...
                {
                    data: 'TglDaftar_pelamar'
                },
                {
                    data: 'nama_pelamar'
                },
                {
                    data: 'tgllahir_pelamar'
                },
                {
                    data: 'umur_pelamar'
                },
                ...
                {
                    data: 'pdkterakhir_pelamar'
                },
                {
                    data: 'jurusan_pelamar'
                },
                {
                    data: 'asalsekolah_pelamar'
                },
                {
                    data: 'Foto_pelamar'
                }
        ...
        $('#bulan,#sel_nama,#jk').change(function() {
            userDataTable.draw();
        });
