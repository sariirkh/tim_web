        ...
        <form action="<?php echo base_url(); ?>laporan/laporan" method="POST" class="row">
            ...
            <div class="col-md-2">
                <select class="form-control" name="jk" id="jk" required>
                    ...
                    <option value="Laki-laki">Stok awal</option>
                    <option value="Perempuan">Stok akhir</option>
                </select>
            </div>
            ...
            <div class="table-responsive">
                 <table id="userTable" class="table table-striped table-hover table-bordered  table-custom">
                    ...
                    <tbody>
                        ...
                        <td><?= $a->jenis  ?></td>
                        <td>
                            <a class="btn btn-info" href="<?= base_url('Laporan/detail/'.$a->id_barang_masuk);  ?>">Detail</a>
                        </td>
                        </tr>
                        <?php } ?>
                    </tbody>
