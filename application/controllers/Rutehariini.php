...
class Rutehariini extends CI_Controller 
{
	...
	*/
	...
	var $viewLink="Requesthariini";
	// var $viewLink2="Users";
	//sub menu atau header
	var $breadcrumbTitle="Data Request Rute Hari ini";
	//var $breadcrumbTitle2="User Access";
	// buat tampilan view data
	var $viewPage="Admviewruteskr";
	
	//query
	var $ordQuery=" ORDER BY id_lokasi DESC";
	var $tgl="date('Y-m-d')";
	var $tableQuery="tb_lokasi AS a INNER JOIN tb_kendaraan AS b ON a.id_kendaraan = b.id_kendaraan WHERE a.tanggal = '$tgl'";
